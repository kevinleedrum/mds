...
export class MxMenu {
  ...
  static get properties() { return {
    ...
    "autocompleteOnly": {
      ...
      "docs": {
        "tags": [],
        "text": "If the anchor element contains an `input`, setting this to `true` will always select the first menu item when Enter is pressed inside the input."
      },
      "attribute": "autocomplete-only",
      "reflect": false,
      "defaultValue": "false"
    },
    "triggerEl": {
