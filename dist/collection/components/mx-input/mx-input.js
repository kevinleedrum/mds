...
export class MxInput {
    ...
    return (h(Host, { class: 'mx-input block' + (this.disabled ? ' disabled' : '') },
      ...
      h("div", { class: this.containerClass, onClick: this.onContainerClick.bind(this) },
        ...
        !this.textarea && (this.maxlength || this.suffix || this.error || this.rightIcon) && (h("span", { class: this.rightContentClass },
          this.maxlength && !this.hideCharacterCount && (h("span", { "data-testid": "character-count", class: "character-count pointer-events-none" },
            this.characterCount,
            "/",
            this.maxlength)),
      ...
      (this.assistiveText || (this.textarea && this.maxlength && !this.hideCharacterCount)) && (h("div", { class: "flex justify-between caption1 mt-4 ml-16 space-x-32" },
        h("span", { "data-testid": "assistive-text", class: "assistive-text" }, this.assistiveText),
        this.textarea && this.maxlength && !this.hideCharacterCount && (h("span", { "data-testid": "character-count", class: "character-count" },
          this.characterCount,
          "/",
          this.maxlength))))));
  }
  ...
  static get properties() { return {
    ...
    "hideCharacterCount": {
      ...
      "docs": {
        "tags": [],
        "text": "Set to `true` to hide the character count when a `maxlength` is set."
      },
      "attribute": "hide-character-count",
      "reflect": false,
      "defaultValue": "false"
    }
  }; }
