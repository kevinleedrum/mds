...
const MxDatePicker = class {
  ...
  componentWillRender() {
    ...
    utils.propagateDataAttributes.call(this);
  }
  componentDidLoad() {
    if (!this.inputEl)
      return;
