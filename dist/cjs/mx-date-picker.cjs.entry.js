...
var datepicker_min = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const datepicker = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(datepicker_min);
...
const MxDatePicker = class {
  ...
  async openCalendar() {
    ...
    this.popoverInstance = await popover.createPopover(this.calendarButton, this.datepicker.calendarContainer, 'bottom', [
      -4,
      0,
    ]);
    await transitions.fadeIn(this.datepicker.calendarContainer);
  }
  repositionCalendar() {
    requestAnimationFrame(this.popoverInstance.forceUpdate);
  }
  async closeCalendar() {
    await transitions.fadeOut(this.datepicker.calendarContainer);
    this.datepicker.calendarContainer.classList.add('hidden');
    if (!this.inputEl.contains(document.activeElement))
      this.isFocused = false;
...
exports.mx_date_picker = MxDatePicker;
