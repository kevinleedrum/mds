...
const MxChart = class {
  ...
  render() {
    return (index.h(index.Host, { class: "mx-chart relative block", style: this.chartStyle }, index.h("canvas", { ref: el => (this.canvasEl = el), role: "img", "aria-label": this.elAriaLabel, style: this.chartStyle })));
  }
