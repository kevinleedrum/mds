...
const MxCode = class {
  ...
  render() {
    return (index.h(index.Host, { class: "mx-code" }, index.h("pre", { class: this.preClass, "data-start": this.showLineNumbers ? this.lineNumberStart : null }, index.h("code", { ref: el => (this.codeEl = el), class: this.languageClass, innerHTML: this.codeHTML }, index.h("slot", null)))));
  }
  get element() { return index.getElement(this); }
};

exports.mx_code = MxCode;
