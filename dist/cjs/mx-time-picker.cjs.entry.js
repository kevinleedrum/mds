...
const MxTimePicker = class {
  ...
  onBlur() {
    ...
    if (!this.isTimeInputSupported && this.isInputDirty) {
      const time = utils.parseTimeString(this.inputElem.value);
      if (time === null) {
...
exports.mx_time_picker = MxTimePicker;
