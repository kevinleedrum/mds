...
const MxImageUpload = class {
  ...
  render() {
    ...
    if (this.icon) {
      ...
      iconJsx = index.h("span", { "data-testid": "avatar-icon", innerHTML: userCircleSvg });
    }
    else {
      iconJsx = index.h("span", { "data-testid": "image-icon", class: this.showDropzoneText ? 'mb-8' : '', innerHTML: imageSvg });
    }
    return (index.h(index.Host, { class: "mx-image-upload inline-block", style: { width: this.dropzoneWidth } }, index.h("div", { "data-testid": "dropzone-wrapper", class: "dropzone-wrapper flex w-full items-center justify-center relative rounded-2xl text-3 overflow-hidden", style: { height: this.dropzoneHeight } }, index.h("div", { class: this.dropzoneClass }, index.h("div", { class: "flex flex-col items-center justify-center w-full h-full" }, this.showIcon && iconJsx, index.h("slot", { name: "dropzone-text" }, index.h("div", { "data-testid": "dropzone-text", class: 'text-center' + (this.showDropzoneText && !this.avatar ? '' : ' hidden') }, index.h("p", { class: "subtitle1 my-0" }, "No ", this.assetName, " to show"), index.h("p", { class: "text-4 my-0 mt-4" }, "Click to add ", this.assetName)))), index.h("svg", { class: "dashed-border absolute inset-0 pointer-events-none", width: "100%", height: "100%" }, index.h("rect", { width: "100%", height: "100%", fill: "none", rx: "16", ry: "16", "stroke-width": "1", "stroke-dasharray": "4,8" })), index.h("input", { ref: el => (this.fileInput = el), id: this.inputId, name: this.name, type: "file", accept: this.accept, class: "absolute inset-0 opacity-0 cursor-pointer", onInput: this.onInput.bind(this), onDragOver: this.onDragOver.bind(this), onDragLeave: this.onDragLeave.bind(this), onDrop: this.onDragLeave.bind(this) })), this.hasFile && this.thumbnailBackgroundImage && (index.h("div", { "data-testid": "thumbnail", class: "thumbnail absolute inset-0 bg-center bg-no-repeat pointer-events-none", style: { backgroundImage: this.thumbnailBackgroundImage, backgroundSize: this.thumbnailBackgroundSize } })), index.h("div", { "data-testid": "uploaded", class: 'flex items-center justify-center absolute inset-0 pointer-events-none ' +
        (this.isUploaded ? '' : ' hidden') }, index.h("slot", { name: "uploaded" })), this.isUploading && (index.h("div", { "data-testid": "progress", class: "uploading-progress flex items-center justify-center opacity-50 absolute inset-0" }, index.h("mx-circular-progress", { size: "2rem" })))), this.showButton && (index.h("mx-button", { "data-testid": "upload-button", class: "mt-16", btnType: this.hasFile && !this.isUploading ? 'outlined' : 'contained', onClick: this.onButtonClick.bind(this), disabled: this.isUploading }, this.hasFile && !this.isUploading ? this.removeButtonLabel : this.uploadButtonLabel)), this.hasInstructions && (index.h("p", { class: "caption1 my-16" }, index.h("slot", { name: "instructions" }))), this.hasSuccess && (index.h("p", { class: "upload-success caption1 my-16" }, index.h("slot", { name: "success" }))), this.hasError && (index.h("p", { class: "upload-error caption1 my-16" }, index.h("slot", { name: "error" })))));
  }
