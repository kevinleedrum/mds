...
const MxBadge = class {
  ...
  render() {
    return (index.h(index.Host, { class: "mx-badge inline-flex relative" }, index.h("slot", null), this.indicator != null ? (index.h("span", { class: this.badgeClassNames, "data-testid": 'indicator-' + (this.indicator || 'circle'), innerHTML: this.indicatorSvg })) : (index.h("span", { class: this.badgeClassNames }, this.icon && index.h("i", { class: this.icon + (this.isIconOnly ? '' : ' mr-4') }), this.value))));
  }
