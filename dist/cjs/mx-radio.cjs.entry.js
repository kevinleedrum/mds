...
const MxRadio = class {
  ...
  render() {
    return (index.h(index.Host, { class: "mx-radio" }, index.h("label", { class: "relative inline-flex flex-nowrap align-center items-center cursor-pointer text-sm" }, index.h("input", { class: "absolute h-0 w-0 opacity-0", type: "radio", name: this.name, checked: this.checked }), index.h("span", { class: "flex h-20 w-20 cursor-pointer rounded-full" }), index.h("div", { class: "ml-16 inline-block" }, this.labelName))));
  }
};
