...
export declare function createPopover(anchorEl: HTMLElement, popoverEl: HTMLStencilElement, placement: PopoverPlacement, offset?: PopoverOffset): Promise<PopoverInstance>;
