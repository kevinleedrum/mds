import { r as registerInstance, h, e as Host, g as getElement } from './index-a1e2f5c6.js';
...
const McButton = class {
  ...
  render() {
    const buttonContent = (h("div", { class: "grid w-full justify-center items-center relative overflow-hidden whitespace-nowrap", style: { gridTemplateColumns: this.gridTemplateColumns } }, this.showLeft && (h("span", { class: "flex items-center justify-self-start mr-10", "data-testid": "left-content" }, h("slot", { name: "left" }), this.iconLeft && h("i", { class: 'text-3 ' + this.iconLeft }))), h("span", { class: "slot-content truncate" }, h("slot", null)), this.showRight && (h("span", { class: "flex items-center justify-self-end ml-10", "data-testid": "right-content" }, (this.iconRight || this.dropdown) && (h("i", { "data-testid": "dropdown-icon", class: `text-3 ${this.dropdown ? 'mds-caret-down-fill' : this.iconRight}` })), h("slot", { name: "right" })))));
